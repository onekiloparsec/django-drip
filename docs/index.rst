...
Finally, be sure to run ``python manage.py migrate drip`` to set up
...
This email generation and creation of the ``EmailMultiAlternatives`` instance that will be sent is done by the
